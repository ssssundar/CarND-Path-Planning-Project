...
int main() {
  ...
  // Left lane is 0, middle lane is 1 and right lane is 2.
  // Car is starting in the middle lane.
  int lane = 1;
        	...
        	// Main car's localization Data
          	...
          	auto sensor_fusion = j[1]["sensor_fusion"];
                ...
                behavPlanner.determineLaneAndVelocity( other_cars, lane, ref_velocity );
                 ...
                 // Either we will reference the starting point as where the
                 // car is or at the previous path's end point.
                 double ref_x = car_x;
                 double ref_y = car_y;
                 ...
                 // Shift the frame of reference to the car's  local reference.
                 // This helps with the simplifying teh math.
                 // This is something we did in the MPC project also.
                 ...
                 // Fill up the rest of our path plannerafter filling it with
                 // previous points. Here we will always output 50 points.
                 // N * 0.02 * velocity = target distance.
